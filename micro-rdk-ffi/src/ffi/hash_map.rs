...
/// the pointer will remain valid until the call to `hashmap_cstring_ptr_destroy` after which
...
/// Any stored value will not be freed
/// # Safety
/// `ctx` must be a valid pointer
#[no_mangle]
pub unsafe extern "C" fn hashmap_cstring_ptr_destroy(ctx: *mut hashmap_cstring_ptr) -> viam_code {
    if ctx.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn hashmap_cstring_ptr_iterate_over_keys(
    ctx: *mut hashmap_cstring_ptr,
