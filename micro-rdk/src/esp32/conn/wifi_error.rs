...
/*
pub enum WifiErrReason {
    Unspecified = wifi_err_reason_t_WIFI_REASON_UNSPECIFIED,
    AuthExpire = wifi_err_reason_t_WIFI_REASON_AUTH_EXPIRE,
    AuthLeave = wifi_err_reason_t_WIFI_REASON_AUTH_LEAVE,
    AssocExpire = wifi_err_reason_t_WIFI_REASON_ASSOC_EXPIRE,
    AssocTooMany = wifi_err_reason_t_WIFI_REASON_ASSOC_TOOMANY,
    NotAuthed = wifi_err_reason_t_WIFI_REASON_NOT_AUTHED,
    NotAssoced = wifi_err_reason_t_WIFI_REASON_NOT_ASSOCED,
    AssocLeave = wifi_err_reason_t_WIFI_REASON_ASSOC_LEAVE,
    AssocNotAuthed = wifi_err_reason_t_WIFI_REASON_ASSOC_NOT_AUTHED,
    DisassocPwrcapBad = wifi_err_reason_t_WIFI_REASON_DISASSOC_PWRCAP_BAD,
    DisassocSupchanBad = wifi_err_reason_t_WIFI_REASON_DISASSOC_SUPCHAN_BAD,
    BssTransitionDisassoc = wifi_err_reason_t_WIFI_REASON_BSS_TRANSITION_DISASSOC,
    IeInvalid = wifi_err_reason_t_WIFI_REASON_IE_INVALID,
    MicFailure = wifi_err_reason_t_WIFI_REASON_MIC_FAILURE,
    FourWayHandshakeTimeout = wifi_err_reason_t_WIFI_REASON_4WAY_HANDSHAKE_TIMEOUT,
    GroupKeyUpdateTimeout = wifi_err_reason_t_WIFI_REASON_GROUP_KEY_UPDATE_TIMEOUT,
    IeInFourWayDiffers = wifi_err_reason_t_WIFI_REASON_IE_IN_4WAY_DIFFERS,
    GroupCipherInvalid = wifi_err_reason_t_WIFI_REASON_GROUP_CIPHER_INVALID,
    PairwiseCipherInvalid = wifi_err_reason_t_WIFI_REASON_PAIRWISE_CIPHER_INVALID,
    AkmpInvalid = wifi_err_reason_t_WIFI_REASON_AKMP_INVALID,
    UnsuppRsnIeVersion = wifi_err_reason_t_WIFI_REASON_UNSUPP_RSN_IE_VERSION,
    InvalidRsnIeCap = wifi_err_reason_t_WIFI_REASON_INVALID_RSN_IE_CAP,
    AuthFailed802_1x = wifi_err_reason_t_WIFI_REASON_802_1X_AUTH_FAILED,
    CipherSuiteRejected = wifi_err_reason_t_WIFI_REASON_CIPHER_SUITE_REJECTED,
    TDlsPeerUnreachable = wifi_err_reason_t_WIFI_REASON_TDLS_PEER_UNREACHABLE,
    TDlsUnspecified = wifi_err_reason_t_WIFI_REASON_TDLS_UNSPECIFIED,
    SspRequestedDisassoc = wifi_err_reason_t_WIFI_REASON_SSP_REQUESTED_DISASSOC,
    NoSspRoamingAgreement = wifi_err_reason_t_WIFI_REASON_NO_SSP_ROAMING_AGREEMENT,
    BadCipherOrAkm = wifi_err_reason_t_WIFI_REASON_BAD_CIPHER_OR_AKM,
    NotAuthorizedThisLocation = wifi_err_reason_t_WIFI_REASON_NOT_AUTHORIZED_THIS_LOCATION,
    ServiceChangePercludesTs = wifi_err_reason_t_WIFI_REASON_SERVICE_CHANGE_PERCLUDES_TS,
    UnspecifiedQos = wifi_err_reason_t_WIFI_REASON_UNSPECIFIED_QOS,
    NotEnoughBandwidth = wifi_err_reason_t_WIFI_REASON_NOT_ENOUGH_BANDWIDTH,
    MissingAcks = wifi_err_reason_t_WIFI_REASON_MISSING_ACKS,
    ExceededTxOp = wifi_err_reason_t_WIFI_REASON_EXCEEDED_TXOP,
    StaLeaving = wifi_err_reason_t_WIFI_REASON_STA_LEAVING,
    EndBA = wifi_err_reason_t_WIFI_REASON_END_BA,
    UnknownBA = wifi_err_reason_t_WIFI_REASON_UNKNOWN_BA,
    Timeout = wifi_err_reason_t_WIFI_REASON_TIMEOUT,
    PeerInitiated = wifi_err_reason_t_WIFI_REASON_PEER_INITIATED,
    ApInitiated = wifi_err_reason_t_WIFI_REASON_AP_INITIATED,
    InvalidFtActionFrameCount(wifi_err_reason_t_WIFI_REASON_INVALID_FT_ACTION_FRAME_COUNT),
    InvalidPmkid = wifi_err_reason_t_WIFI_REASON_INVALID_PMKID,
    InvalidMde = wifi_err_reason_t_WIFI_REASON_INVALID_MDE,
    InvalidFte = wifi_err_reason_t_WIFI_REASON_INVALID_FTE,
    TransmissionLinkEstablishFailed =
        wifi_err_reason_t_WIFI_REASON_TRANSMISSION_LINK_ESTABLISH_FAILED,

    AlternativeChannelOccupied = wifi_err_reason_t_WIFI_REASON_ALTERATIVE_CHANNEL_OCCUPIED,
    BeaconTimeout = wifi_err_reason_t_WIFI_REASON_BEACON_TIMEOUT,
    NoApFound = wifi_err_reason_t_WIFI_REASON_NO_AP_FOUND,
    AuthFail = wifi_err_reason_t_WIFI_REASON_AUTH_FAIL,
    AssocFail = wifi_err_reason_t_WIFI_REASON_ASSOC_FAIL,
    HandshakeTimeout = wifi_err_reason_t_WIFI_REASON_HANDSHAKE_TIMEOUT,
    ConnectionFail = wifi_err_reason_t_WIFI_REASON_CONNECTION_FAIL,
    ApTsfReset = wifi_err_reason_t_WIFI_REASON_AP_TSF_RESET,
    Roaming = wifi_err_reason_t_WIFI_REASON_ROAMING,
    AssocComebackTimeTooLong = wifi_err_reason_t_WIFI_REASON_ASSOC_COMEBACK_TIME_TOO_LONG,
    SaQueryTimeout = wifi_err_reason_t_WIFI_REASON_SA_QUERY_TIMEOUT,
    NoApFoundWithCompatibleSecurity =
        wifi_err_reason_t_WIFI_REASON_NO_AP_FOUND_W_COMPATIBLE_SECURITY,

    NoApFoundInAuthModeThreshold = wifi_err_reason_t_WIFI_REASON_NO_AP_FOUND_IN_AUTHMODE_THRESHOLD,
    NoApFoundInRssiThreshold = wifi_err_reason_t_WIFI_REASON_NO_AP_FOUND_IN_RSSI_THRESHOLD,
}
*/
